        ...
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0a0e1a', color: '#fff', fontFamily: 'system-ui, sans-serif', padding: '2rem' }}>
          <div style={{ maxWidth: 480, textAlign: 'center' }}>
            ...
            <p style={{ color: '#94a3b8', fontSize: '0.875rem', marginBottom: '1rem' }}>
              Aplikasi gagal dimuat. Coba refresh halaman.
            </p>
            ...
            <button onClick={() => window.location.reload()} style={{ marginTop: '1.5rem', padding: '0.6rem 1.5rem', background: '#3b82f6', color: '#fff', border: 'none', borderRadius: '0.5rem', cursor: 'pointer', fontSize: '0.875rem' }}>
              Refresh
            </button>
          </div>
        </div>
